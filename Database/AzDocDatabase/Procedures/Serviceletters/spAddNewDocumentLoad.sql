...
CREATE PROCEDURE [serviceletters].[spAddNewDocumentLoad] @docType     INT = NULL, 
                                                        @workPlaceId INT = 0, 
                                                        @formTypeId  INT = 0, 
                                                        @docId       INT = NULL
AS
                        ...
                        (
                            ...
                            (
                                ...
                                (
                                    ...
                                    WHERE ddp.PositionGroupId IN(1, 2,17, 36,37)
                                )
                            )
                            UNION
                            SELECT 3 FormTypeId, 
                            ...
                            (
                                ...
                                (
                                    ...
                                    (
                                        SELECT dpg.PositionGroupId
                                        FROM dbo.DC_POSITION_GROUP dpg
                                        WHERE dpg.PositionGroupId IN(1 ,2, 33,34,35,36,6, 5)
                                    )
                                )
                            )
                            UNION
                            ...
                            (
                                ...
                                (
                                    ...
                                    WHERE a.AdrDocId = @docId
										...
										CASE WHEN d.DocPlannedDated IS NULL then	
											d.DocPlannedDate
									   ELSE 
											d.DocPlannedDated
									    end AS PlannedDate, 
