...
CREATE PROCEDURE [serviceletters].[spOperationConfirmSignature] @docId       INT, 
                                                               @docTypeId   INT, 
                                                               @workPlaceId INT, 
...
AS
    BEGIN
                                    ...
                                    BEGIN
                                        ...
                                        (
                                            ...
                                            BEGIN
                                                ...
                                                (
                                                    SELECT *
                                                    FROM dbo.DOCS_EXECUTORINFO deu
                                                    WHERE deu.InfoDocId = @relatedDocumentId
                                                )
                                                    BEGIN
                                                        UPDATE dbo.DOCS_EXECUTORINFO
                                                          SET 
                                                              dbo.DOCS_EXECUTORINFO.DocumentStatusId = 12 -- int
                                                        WHERE dbo.DOCS_EXECUTORINFO.InfoDocId = @relatedDocumentId
                                                              AND dbo.DOCS_EXECUTORINFO.ExecutorId =
                                                        (
															...
															AND de.ExecutorMain=1 AND de.SendStatusId=1 /*Reshid deyishdi*/
        ...
        END;
            ...
            BEGIN
                EXEC serviceletters.spSendToConfirmedPerson 
                     @docId = @docId, 
                     @docTypeId = @docTypeId, 
                     @workPlaceId = @workPlaceId, 
