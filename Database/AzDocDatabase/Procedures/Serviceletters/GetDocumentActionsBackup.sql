...
-- =============================================
CREATE PROCEDURE [serviceletters].[GetDocumentActionsBackup] @docId       INT, 
                                                      @workPlaceId INT, 
                                                      @menuTypeId  INT = 0
AS
    BEGIN
        ...
        END;
            ...
            IF(@sendStatus = 1
               AND @executorReadStatus = 0
               AND @positonGroupId IN(5, 6,7, 17)) -- Icra ucun Oxunmamis veziyyeti
                BEGIN
                    IF((@orgId <> 1
                ...
                END;
                    ...
                    END;
                        ...
                        END;
                            ...
                            IF(@sendStatus = 2
                               AND @executorReadStatus = 0
                               AND @positonGroupId IN(5, 6, 9, 17, 26, 36)) -- Icra ve melumat ucun Oxunmamis veziyyeti
                                BEGIN
