...
-- =============================================
CREATE PROCEDURE [serviceletters].[GetDocumentActions] @docId       INT, 
                                                      @workPlaceId INT, 
                                                      @menuTypeId  INT = 0
AS
    BEGIN
        ...
        IF(((@sendStatus IS NULL)
            OR (@sendStatus IN(0, 7, 8, 10, 12,15)))
        ...
        END;
            ...
            IF(@sendStatus = 1
               AND @executorReadStatus = 0
               AND @positonGroupId IN(5, 6,7,13, 17)) -- Icra ucun Oxunmamis veziyyeti
                BEGIN
                    IF((@orgId <> 1
                ...
                END;
                    ...
                    END;
                        ...
                        IF(@sendStatus = 1
                           ...
                           AND @positonGroupId IN(5, 6, 9,13, 17, 26)) -- Icra ucun Oxunmus veziyyeti
                            BEGIN
                                IF((@orgId <> 1
                                    AND @positonGroupId = 5)
                                   OR (@orgId = 1
                        ...
                        END;
                            ...
                            IF(@sendStatus = 2
                               AND @executorReadStatus = 0
                               AND @positonGroupId IN(5, 6, 9, 13,17, 26, 36)) -- Icra ve melumat ucun Oxunmamis veziyyeti
                                BEGIN
                            ...
                            END;
                                ...
                                IF(@sendStatus = 2
                                   AND @executorReadStatus = 1
                                   AND @positonGroupId IN(5, 6, 9, 13,17, 26)) -- Icra ve melumat ucun oxunmus veziyyeti
                                    BEGIN
                                        INSERT INTO @Actions
                                        (Id, 
                                         Name, 
                                    ...
                                    END;
                                        ...
                                        IF((@sendStatus = 3
                                           ...
                                           AND (@positonGroupId = 1
                                                ...
                                                OR @positonGroupId = 26
												OR @positonGroupId = 36)) --Melumat ucun Oxunmamis veziyyeti -- Kime unbanlanibdan daxil olub
                                            BEGIN
                                                INSERT INTO @Actions
                                                (Id, 
                                                 Name, 
