...
-- =============================================
CREATE PROCEDURE [serviceletters].[spSendToConfirmedPerson]
@docId int,
@docTypeId int,
@workPlaceId int,
...
BEGIN
 declare 
   ...
   @fileId int,
   @executorId int,
   @vizaPersonelId int --Shahriyar elave etdi;
   SELECT @vizaPersonelId=dp.PersonnelId
    ...
    WHERE dw.WorkplaceId = @confirmWorkPlaceId; --Shahriyar elave etdi;
