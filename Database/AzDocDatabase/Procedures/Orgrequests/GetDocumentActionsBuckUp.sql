...
CREATE PROCEDURE [orgrequests].[GetDocumentActionsBuckUp] @docId       INT, 
                                                       @workPlaceId INT, 
                                                       @menuTypeId  INT
AS
    BEGIN
                    ...
                    END;
                        ...
                        END;
                            ...
                            END;
                                ELSE
                                IF(@sendStatus = 2
                                   AND @positonGroupId IN(5, 6, 17,36,37,38))
                                    BEGIN
        ...
        END;
            ...
            (
                ...
                BEGIN
                    ...
                    END;
                    IF(@sendStatus = 1
                       AND @positonGroupId IN(5, 6, 9, 18, 17, 26,37,38))
                        BEGIN
                            IF((@orgId <> 1
                                AND @positonGroupId = 5)
                               OR (@orgId = 1
