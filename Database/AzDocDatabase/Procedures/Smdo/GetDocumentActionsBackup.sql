...
-- =============================================
CREATE PROCEDURE [smdo].[GetDocumentActionsBackup] @docId       INT, 
                                                      @workPlaceId INT, 
                                                      @menuTypeId  INT = 0
AS
    BEGIN
        ...
        IF(((@sendStatus IS NULL) OR (@sendStatus in(0,7,8,12)))
        ...
        END;
            ...
            IF(@sendStatus = 1
               AND @executorReadStatus = 0
               AND @positonGroupId in(5,6,9,17,26)) -- Icra ucun Oxunmamis veziyyeti
                BEGIN
                    INSERT INTO @Actions
                    (Id, 
                     Name, 
                                ...
                                END;
                                    ...
                                    END;
                                        ...
                                        IF((@sendStatus = 3
                                           ...
                                           AND @executorReadStatus = 0
                                           AND @directionType = 1
                                           ) --Melumat ucun Oxunmamis veziyyeti -- Derkenardan  daxil olub
                                            BEGIN
                                                INSERT INTO @Actions
                                                (Id, 
                                                 Name, 
