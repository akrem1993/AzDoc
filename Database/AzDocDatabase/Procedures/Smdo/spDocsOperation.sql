...
CREATE PROCEDURE [smdo].[spDocsOperation] @operationType      INT, 
                    ...
                    (RelatedDocId, 
                     ...
                     RelatedTypeId
                           ...
                           SELECT @docId RelatedDocId, 
                                  r.DocId RelatedDocumentId, 
                                  1 RelatedTypeId
                           FROM @related r  WHERE r.docid NOT IN (SELECT dr.RelatedDocumentId FROM dbo.DOCS_RELATED dr WHERE dr.RelatedDocId=@docId AND dr.RelatedTypeId=1); 
                            ...
                            (RelatedDocId, 
                             ...
                             RelatedTypeId
                                   ...
                                   SELECT @docId RelatedDocId, 
                                          a.DocId RelatedDocumentId, 
                                          2 RelatedTypeId
                                   FROM @answer a where a.DocId NOT IN (SELECT dr.RelatedDocumentId FROM dbo.DOCS_RELATED dr WHERE dr.RelatedDocId=@docId AND dr.RelatedTypeId=2);
