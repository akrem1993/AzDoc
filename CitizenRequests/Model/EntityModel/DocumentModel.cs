...
namespace CitizenRequests.Model.EntityModel
{
    public class DocumentModel
    {
        ...
        private float? numberOfApplicants;

        public float? NumberOfApplicants
        {
            get => numberOfApplicants ?? -1;
            set => numberOfApplicants = value;
        }
