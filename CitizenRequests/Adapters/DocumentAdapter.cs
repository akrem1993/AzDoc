...
using CitizenRequests.Model.FormModel;
...
namespace CitizenRequests.Adapters
{
    public class DocumentAdapter : AdapterBase
    {
        ...
        public DocumentInfoViewModel GetDocView(int docId)
        {
            ...
            return UnitOfWork.ExecuteProcedure<DocumentInfoViewModel>("[citizenrequests].[GetDocView]", parameters).FirstOrDefault();
        }
        ...
        public IEnumerable<Applicant> GetDocApplicants(int docId)
        {
            ...
            return UnitOfWork.ExecuteCommand<Applicant>("SELECT dav.* FROM citizenrequests.DocApplicantsView dav	 WHERE dav.AppDocId=@docId", parameters);
        }
        ...
        public IEnumerable<PreviosRequests> GetDocPreviousRequests(int docId)
        {
            ...
            return UnitOfWork.ExecuteProcedure<PreviosRequests>($"[citizenrequests].[GetPreviousRequests]",parameters);
        }
        ...
        public DocumentGridViewModel GetDocumentGridModel(string docIds, int workPlaceId)
        {
            ...
            var data = UnitOfWork.ExecuteProcedure<DocumentGridModel>("[citizenrequests].[GetDocs]", parameters).ToList();
        ...
        public IEnumerable<DocResult> GetDocResultModel(int workPlaceId, int? periodId, int docType, int? pageIndex, int pageSize, List<SqlParameter> searchParams)
        {
            ...
            return UnitOfWork.ExecuteProcedure<DocResult>("[citizenrequests].[GetFilteredDocs]", parameters);
        }
        ...
        public List<ChooseModel> GetChooseModel(int docType, int workPlaceId)
        {
            var parameters = Extension.Init()
                        .Add("@docType", docType)
                        .Add("@workPlaceId", workPlaceId);
            return UnitOfWork.ExecuteProcedure<ChooseModel>("[citizenrequests].[spAddNewDocumentLoad]", parameters).ToList();
        }
        ...
        public List<RelatedDocModel> GetRelatedDocModel()
        {
            ...
            return UnitOfWork.ExecuteProcedure<RelatedDocModel>("[citizenrequests].[spAddNewDocumentLoad]", parameters).ToList();
        }
        ...
        public List<AuthorModel> GetAuthorModel()
        {
            ...
            return UnitOfWork.ExecuteProcedure<AuthorModel>("[citizenrequests].[spAddNewDocumentLoad]", parameters).ToList();
        }
        ...
        public List<SubordinateModel> GetSubordinateModel(int organizationId, int docTopicId)
        {
            ...
            return UnitOfWork.ExecuteProcedure<SubordinateModel>("[citizenrequests].[spAddNewDocumentLoad]", parameters).ToList();
        }
        ...
        public List<SubtitleModel> GetSubtitleModel(int topicTypeId)
        {
            ...
            return UnitOfWork.ExecuteProcedure<SubtitleModel>("[citizenrequests].[spAddNewDocumentLoad]", parameters).ToList();
        }
        /// <summary>
        /// ///
        /// </summary>
        ...
        public List<RegionModel> GetRegionModel(int countryId)
        {
            ...
            return UnitOfWork.ExecuteProcedure<RegionModel>("[citizenrequests].[spAddNewDocumentLoad]", parameters).ToList();
        }
        ...
        public List<ApplyAgainModel> GetApplyAgainModel(int docType, string surName, string firstName, int organizationId)
        {
            ...
            var data = UnitOfWork.ExecuteProcedure<ApplyAgainModel>("[citizenrequests].[spGetApplicant]", parameters).ToList();
            return data;
        }
        ...
        public DocumentModel GetDocumentModel(int docId)
        {
            ...
            string jsonData = UnitOfWork.ExecuteProcedure<string>("[citizenrequests].[spAddNewDocumentLoad]", parameters).Aggregate((i, j) => i + j);
        ...
        public int SaveDocument(int workPlaceId, int docType, int? docId, DocumentFormModel model, out int result)
        {
            try
            {
                var parameters = Extension.Init()
                        ...
                        .Add("@numberOfApplicants", (int?)model.DocumentModel.NumberOfApplicants)
                ...
                if (dataAuthor != null)
                    parameters.Add("@author", dataAuthor, "[citizenrequests].[UdttAuthor]");
                if (dataApplication != null)
                    parameters.Add("@application", dataApplication, "[dbo].[UdttApplication]");

                UnitOfWork.ExecuteNonQueryProcedure("[citizenrequests].[spDocsOperation]", parameters);
        ...
        public DocumentInfoViewModel DocInfo(int docId, int workPlaceId, int docType)
        {
            try
            {
                ...
                string jsonData = UnitOfWork.ExecuteProcedure<string>("[citizenrequests].spGetDocView", parameters).Aggregate((i, j) => i + j);
        ...
        public ElectronicDocumentViewModel ElectronicDocument(int docId, int docType, int workPlaceId, int executorId)
        {
            try
            {
                ...
                string jsonData = UnitOfWork.ExecuteProcedure<string>("[citizenrequests].[spGetElectronicDocument]", parameters).Aggregate((i, j) => i + j);
