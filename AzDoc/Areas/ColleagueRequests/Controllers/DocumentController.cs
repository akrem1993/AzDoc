...
using DocumentAdapter = ColleagueRequests.Adapters.DocumentAdapter;
...
namespace AzDoc.Areas.ColleagueRequests.Controllers
{
    ...
    public class DocumentController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("~/Areas/ColleagueRequests/Views/Document/Index.cshtml");
        }
        ...
        public ActionResult AddNewDocument()
        {
            ...
            using (DocumentAdapter adapter = new DocumentAdapter(unitOfWork))
            {
                ...
                return View("~/Areas/ColleagueRequests/Views/Document/AddNewDocument.cshtml", model);
            }
        }
        ...
        public ActionResult EditDocument()
        {
            ...
            using (DocumentAdapter adapter = new DocumentAdapter(unitOfWork))
            {
                ...
                return View("~/Areas/ColleagueRequests/Views/Document/EditDocument.cshtml", model);
            }
        }
        ...
        public ActionResult ElectronicDocument(int docId, int executorId)
        {
            ...
            using (var docInfoAdapter = new DocInfoAdapter(unitOfWork))
            {
                ...
                return View("~/Areas/ColleagueRequests/Views/Document/ElectronicDocument.cshtml", model);
            }
        }
        ...
        public ActionResult DocumentDisplay(int docInfoId)
        {
            ...
            return PartialView("~/Areas/ColleagueRequests/Views/Document/DocumentDisplay.cshtml");
        }
        ...
        public ActionResult Redirect()
        {
            ...
            return RedirectToRoute("ColleagueRequests");
        }
