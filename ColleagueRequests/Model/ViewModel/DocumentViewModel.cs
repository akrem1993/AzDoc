...
namespace ColleagueRequests.Model.ViewModel
{
    public class DocumentViewModel
    {
        ...
        public ChooseModel ColleagueType { get; set; }
        ...
        public IEnumerable<ChooseModel> ColleagueTypes { get; set; }
        ...
        private const int colleagueType = (int)BasicInformation.ColleagueType;
        ...
        public DocumentViewModel(DocumentAdapter adapter, int docType, int workPlaceId)
        {
            ...
            ColleagueTypes = chooseList.Where(l => l.FormTypeId == colleagueType);
